        ...
        <section className='pb-36 pt-24'>
            <div className="container">
                ...
                <div className="imput_container max-w-[600px] mx-auto relative mt-10">
                    <input className='w-full border border-black rounded-[14px] py-5 px-4 placeholder:capitalize placeholder:text-[#8B8B8B] focus:outline-brandOrange' placeholder='Enter your email address' type="email" />

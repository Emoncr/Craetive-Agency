            ...
            <div >
                <div className="grid grid-cols-2 items-center container mx-auto ">
                    <div className="content_container">
                        ...
                        <p className="font_avenir text-lg font-normal text-black max-w-[472px] text-left">We help businesses like yours earn more customers, standout from competitors,  make more money</p>
                        <button
